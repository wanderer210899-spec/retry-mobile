...
export const ST_EVENT_NAMES = Object.freeze({
...
const REQUIRED_EVENT_NAMES = Object.freeze([
    ST_EVENT_NAMES.CHAT_CHANGED,
    ST_EVENT_NAMES.CHAT_LOADED,
    ST_EVENT_NAMES.CHAT_DELETED,
    ST_EVENT_NAMES.CHAT_COMPLETION_SETTINGS_READY,
    ST_EVENT_NAMES.TEXT_COMPLETION_SETTINGS_READY,
    ST_EVENT_NAMES.GENERATION_ENDED,
    ST_EVENT_NAMES.GENERATION_STOPPED,
    ST_EVENT_NAMES.CHARACTER_MESSAGE_RENDERED,
